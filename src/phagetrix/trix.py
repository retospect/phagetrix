...
class DegenerateCodonGenerator:
    ...
    def __init__(self, degenerate_bases=degenerate['IDT'], 
        ...
        self.degenerate_codons = defaultdict(lambda: \
                                             {"aas": defaultdict(int), 
                                              "expanded_codon_count": 0})
    ...
    def get_best_degenerate_codon(self, amino_acids):
        ...
        for degenerate_codon in degenerate_codons:
            ...
            expanded_codon_count = \
                self.degenerate_codons[degenerate_codon]["expanded_codon_count"]
            ...
            if best_degenerate_codon is None \
               ...
               (num_aas == best_degenerate_codon_aas and \
                expanded_codon_count < best_degenerate_codon_expanded_codon_count) \
               or \
